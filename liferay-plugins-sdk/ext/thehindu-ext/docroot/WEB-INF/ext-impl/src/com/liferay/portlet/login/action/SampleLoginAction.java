 ...
 */
public class SampleLoginAction extends PortletAction {
	...
	public ActionForward render(
		...
		return actionMapping.findForward(
			getForward(renderRequest, "portlet.login.sample"));
	}
	...
	private static Log _log = LogFactoryUtil.getLog(SampleLoginAction.class);
